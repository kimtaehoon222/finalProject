...
<body>
	...
	<div class="container-xxl flex-grow-1 container-p-y">
	  <div class="card mb-4">
      <h3 class="card-header text-primary"><b>게시글 작성</b></h3>
      ...
      <form>
	      <div class="card-body">
	      	<!-- 작성자 -->
	        <div class="mb-3">
	          <label for="exampleFormControlReadOnlyInput1" class="form-label text-primary">Writer</label>
	          <input class="form-control" type="text" id="exampleFormControlReadOnlyInput1" placeholder="임현빈" readonly>
	        </div>
	        <!-- 카테고리 -->
	        <div class="mb-3">
