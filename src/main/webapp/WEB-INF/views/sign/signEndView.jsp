					...
					<table id="signWaitingList" class="table" style="width: 1300px">
						<thead>
							<tr style="text-align: center">
								...
								<th style="color: rgb(124, 127, 251)"><b>최종 승인일</b></th>
						...
						<tbody>
							<c:forEach items="${ list }" var="s">
								...
								<c:if test="${ !empty s.expiryDate }">
									...
									<td>${ s.createName }</td>
									<td>${ s.createDate }</td>
									<td style="color:blue">${ s.finalSignDate }</td>
				...
				<ul class="pagination" id="center">
					<c:choose>
						<c:when test="${ pi.currentPage ne 1 }">
							<li class="page-item"><a class="page-link"
								href="signEndView.do?currentPage=${ pi.currentPage-1 }">이전</a></li>
						</c:when>
						<c:otherwise>
					...
					<c:forEach begin="${ pi.startPage }" end="${ pi.endPage }" var="p">
						<c:choose>
							<c:when test="${ pi.currentPage ne p }">
								<li class="page-item"><a class="page-link"
									href="signEndView.do?currentPage=${ p }">${ p }</a></li>
							</c:when>
							<c:otherwise>
					...
					<c:choose>
						<c:when test="${ pi.currentPage ne pi.maxPage }">
							<li class="page-item"><a class="page-link"
								href="signEndView.do?currentPage=${ pi.currentPage+1 }">다음</a></li>
						</c:when>
						<c:otherwise>
	...
	<div class="modal fade" id="exampleModal" tabindex="-1"
		...
		<div class="modal-dialog">
			...
			<div class="modal-content" id="selectAAList">
				...
				<br>
				<h4 id="center">
					<b >품 의&nbsp<b style="color:blue">(완료)</b></b>
				</h4>
				...
				<form id="updateRRR" method="post" action="updateRR.do">
					...
					<div class="col-md-4">
						...
						<table class="tftable" border="1" hight="10" style="margin: 22px"
							...
							<tr>
								...
								<th style="width: 100px; background-color: #ffffff;"><b
									id="aaFinalSignName"></b> <b style="color: blue"
									id="aaFinalSignDate"></b></th>
							</tr>
						</table>
					...
					<div class="col-md-12">
						...
						function DetailBtn(result)  {
							    ...
							    $("#aaFinalSignDate").html(finalSignDate);
