					...
					<table id="signWaitingList" class="table" style="width: 1300px">
						<thead>
							<tr style="text-align: center">
								...
								<th style="color: rgb(124, 127, 251)"><b>반려일</b></th>
				...
				<ul class="pagination" id="center">
					<c:choose>
						<c:when test="${ pi.currentPage ne 1 }">
							<li class="page-item"><a class="page-link"
								href="signBackView.do?currentPage=${ pi.currentPage-1 }">이전</a></li>
						</c:when>
						<c:otherwise>
					...
					<c:forEach begin="${ pi.startPage }" end="${ pi.endPage }" var="p">
						<c:choose>
							<c:when test="${ pi.currentPage ne p }">
								<li class="page-item"><a class="page-link"
									href="signBackView.do?currentPage=${ p }">${ p }</a></li>
							</c:when>
							<c:otherwise>
					...
					<c:choose>
						<c:when test="${ pi.currentPage ne pi.maxPage }">
							<li class="page-item"><a class="page-link"
								href="signBackView.do?currentPage=${ pi.currentPage+1 }">다음</a></li>
						</c:when>
						<c:otherwise>
	...
	<div class="modal fade" id="exampleModal" tabindex="-1"
		...
		<div class="modal-dialog">
			...
			<div class="modal-content" id="selectAAList">
				...
				<br>
				<h4 id="center">
					<b >품 의&nbsp<b style="color:red">(반려)</b></b>
				</h4>
				...
				<form id="updateRRR" method="post" action="updateRR.do">
					...
					<div class="col-md-12">
						...
						<fieldset style="width: 30%; float: right; margin: 22px;">
							<table class="tftable" border="1" hight="10">
								...
								<tr>
									<th style="background-color: white; height:41.72px"><b id="aaExpiryDate"></b></th>
								</tr>
							</table>
						</fieldset>
					</div>
					...
					<div class="col-md-4">
						...
						<table class="tftable" border="1" hight="10" style="margin: 22px"
							...
							<tr>
								...
								<th rowspan="2" width="10px" style="background-color: #ffffff;">발신</th>
							...
							<tr>
								...
								<th style="width: 50px; background-color: #ffffff;"><b
								
									id="aaCreateName"></b><br> <b style="color: blue" id="aaCreateDate"></b></th>
					...
					<b>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp1차 결재자 : &nbsp<b
					id="aaFirstApprover"></b></b>
					...
					<b style="margin:22px">반려일 : &nbsp<b style="color: red" id="aaRejectDate"></b></b>
					...
					<div class="col-md-12">
						 ...
						 function snoComeOn(signNo){
							$.ajax({ //품의 내용 select 해오기
								  ...
								  success: function(result) {
									  ...
									  console.log(result.firstApprover)
						...
						function DetailBtn(result)  {
								...
								var rejectDate = result.rejectDate; //반려일
							    ...
							    $("#aaFinalSignName").html(finalSignName);
							    $("#aaFinalSignJob").html(finalSignJob);
							    $("#aaRejectDate").html(rejectDate);
							}
	...
	<div class="modal fade" id="exampleModal2" tabindex="-1"
		...
		<div class="modal-dialog">
			...
			<div class="modal-content" id="selectAAList2">
				...
				<br>
				<h4 id="center">
					<b >협 조&nbsp<b style="color:red">(반려)</b></b>
				</h4>
				...
				<div>
					<div class="col-md-12">
						...
						<fieldset style="width: 30%; float: right; margin: 22px;">
							<table class="tftable" border="1" hight="10">
								...
								<tr>
									<th style="background-color: white; height:41.72px"><b id="bbExpiryDate"></b></th>
								</tr>
							</table>
						</fieldset>
					</div>
					...
					<div class="col-md-4">
						...
						<table class="tftable" border="1" hight="10" style="margin: 22px"
							...
							<tr>
								...
								<th style="width: 50px; background-color: #ffffff;"><b
									...
									id="bbCreateName"></b><br> <b style="color: blue" id="bbCreateDate"></b></th>
						...
						function DetailBtnn(result)  {
								...
								$("#bbFirstApprover").html(firstApprover);
					...
					<b>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp1차 결재자 : &nbsp<b
					id="bbFirstApprover"></b></b>
					...
					<div class="modal-body">
						...
						<b id="bbFinalApprover"> </b> <br> <br> 
						
						<b >반려일 : &nbsp<b style="color: red" id="bbRejectDate"></b></b> <br> <br>
	...
	<div class="modal fade" id="exampleModal3" tabindex="-1"
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<br>
				<h4 id="center">
					<b >휴 가 원 &nbsp<b style="color:red">(반려)</b></b>
				</h4>
				...
				<form id="updateRRRRR" method="post" action="updateRR.do">
					...
					<div class="col-md-12">
						...
						<fieldset style="width: 30%; float: right; margin: 22px;">
							<table class="tftable" border="1" hight="10">
								...
								<tr>
									<th style="background-color: white; height:41.72px"><b id="ccVcode"></b></th>
								</tr>
							</table>
						</fieldset>
					</div>
					...
					<b>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp1차 결재선 지정 : &nbsp<b id="ccFirstApprover"></b></b>
					<br>
					<br>
					<b>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp최종 결재선 지정 :  &nbsp<b id="ccFinalApprover"></b></b>
					<br>
					<br>
					<b style="margin:22px">&nbsp반려일 : &nbsp<b style="color: red" id="ccRejectDate"></b></b>
					<div class="col-md-12">
						...
						<script>
						 function snoCCComeOn(signNo){
					 		...
					 		function DetailBtnnn(result)  {
									...
									$("#ccFirstApprover").html(firstApprover);
						...
						<table class="tftable" border="1" hight="10" style="margin: 22px">
							...
							<tr>
								...
								<th style="width: 50px; background-color: #ffffff;"><b
									...
									id="ccCreateName"></b><br> <b style="color: blue" id="ccCreateDate"></b></th>
