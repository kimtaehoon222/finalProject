							...
							<div class="email-app-menu">
								...
								<div class="sidebar-menu-list ps">
									...
									<div class="list-group list-group-messages">
										...
										<a href="sendMailList.do?send=s" class="list-group-item text-primary">
											<div class="fonticon-wrap d-inline me-3">
												<svg class="bi" width="1.5em" height="1.5em" fill="currentColor">
					...
					<div class="content-wrapper">
						<div class="content-body">
							...
							<div class="email-app-area">
											...
											<div
												...
												<c:choose>
													...
													<a class="btn btn-icon btn-primary email-pagination-prev d-none d-sm-block" 
													   href="sendMailList.do?currentPage=${ mpi.currentPage-1 }">
														<svg class="bi" width="1.5em" height="1.5em" fill="currentColor">
														...
														<div class="mail-message">
															...
															<div class="mail-meta-item">
																<span class="float-right d-flex align-items-center">
																	...
																	<c:if test="${ mail.stateCode == '읽음' }">
																		<span class="mail-date text-primary">${ mail.stateCode }</span>
																	</c:if>
																	<c:if test="${ mail.stateCode == '읽지않음' }">
																		<span class="mail-date text-danger">${ mail.stateCode }</span>
																	</c:if>
															</div>
														</div>
													</div>
								...
								<input type="hidden" id="listType" name="listType" value="s">
								</form>
								<!-- form 끝 -->
