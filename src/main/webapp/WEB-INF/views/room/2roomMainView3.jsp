          ...
          <ul class="nav" id="side-menu" style="padding-left: 9%;">
              <li style="padding: 10px 0 0;">
                  ...
                  <ul class="nav_ul">
                     <li>
                        <p class='nav_ul_p'>
                           <label class='smallText firstSmallText' onclick="changeResource(1)" style="margin-top: 5px;">회의실1</label>
                        </p>
                        <p class='nav_ul_p'>
                           <label class='smallText' onclick="changeResource(2)" style="margin-top: 2px;">회의실2</label>
                        </p>
                         <p class='nav_ul_p'>
                           <label class='smallText' onclick="changeResource(3)"  style="margin-top: 2px;">회의실3</label>
                        </p>
                         <p class='nav_ul_p'>
                           <label class='smallText' onclick="changeResource(4)"  style="margin-top: 2px;">회의실4</label>
                        </p>
                     </li>
                  </ul>
              </li>
