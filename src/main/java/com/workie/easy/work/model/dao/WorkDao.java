...
public class WorkDao {
	...
	public ArrayList<EmpVacation> selectEmpVacationList(SqlSession sqlSession, int empNo) {
		
		return (ArrayList)sqlSession.selectList("workMapper.selectEmpVacationList", empNo);
	}
